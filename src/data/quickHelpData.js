export const quickHelpData = [
  ...
  },
  {
    ...
    areaEn: 'Hips',
    areaColor: '#aa7a5a',
    fasciaNote: 'Mięsień biodrowo-lędźwiowy to najsilniejszy zginacz biodra i "centrum" ciała. Skraca się dramatycznie po kilku godzinach siedzenia — dosłownie "przykuwa" cię do pozycji siedzącej. To główna przyczyna bólu dolnych pleców, napięcia w pachwinach i słabej postawy.',
    fasciaNote_en: 'The iliopsoas is the strongest hip flexor and the "core" of the body. It shortens dramatically after hours of sitting — literally "locking" you into a seated position. It\'s the main cause of lower back pain, groin tension, and poor posture.',
    exercises: [
      {
        name: 'Wykrok na zginacze bioder',
        name_en: 'Hip Flexor Lunge',
        time: '2 min',
        requiresStanding: true,
        steps: [
          'Wstań i zrób duży krok prawą nogą do przodu.',
          'Opuść lewe kolano w stronę podłogi — możesz trzymać się biurka.',
          'Poczujesz intensywne rozciąganie z przodu lewego biodra i pachwiny.',
          'Utrzymaj 30 sekund, oddychając spokojnie. Nie pochylaj tułowia do przodu.',
          'Zmień stronę. Powtórz 2 razy na każdą nogę.',
        ],
        stepsEn: [
          'Stand up and take a big step forward with your right foot.',
          'Lower your left knee toward the floor — you can hold the desk for support.',
          'You\'ll feel an intense stretch at the front of your left hip and groin.',
          'Hold for 30 seconds, breathing calmly. Don\'t lean your torso forward.',
          'Switch sides. Repeat 2 times on each leg.',
        ],
        note: 'Mięsień biodrowo-lędźwiowy skraca się ~1 cm na godzinę siedzenia. Ten wykrok to najskuteczniejszy sposób na jego rozciągnięcie — efekty czuć natychmiast.',
        note_en: 'The hip flexor shortens ~1 cm for every hour of sitting. This lunge is the most effective way to stretch it — results are felt immediately.',
      },
      {
        name: 'Rozciąganie gruszkowatego (piriformis)',
        name_en: 'Piriformis Stretch',
        time: '2 min',
        steps: [
          'Usiądź prosto na krześle.',
          'Połóż prawą kostkę na lewym kolanie — noga w kształcie cyfry 4.',
          'Powoli pochyl się lekko do przodu, aż poczujesz rozciąganie w prawym pośladku i biodra.',
          'Utrzymaj 30 sekund, oddychając. Nie garb pleców.',
          'Zmień stronę. Powtórz 2 razy.',
        ],
        stepsEn: [
          'Sit up straight on your chair.',
          'Place your right ankle on your left knee — leg in a "figure 4" shape.',
          'Slowly lean slightly forward until you feel a stretch in your right glute and hip.',
          'Hold for 30 seconds, breathing. Don\'t hunch your back.',
          'Switch sides. Repeat 2 times.',
        ],
        note: 'Rozciąga mięsień gruszkowaty — gdy się spina, uciska nerw kulszowy i powoduje ból promieniujący do nogi. Siedzenie to jego główny wróg.',
        note_en: 'Stretches the piriformis muscle — when tight, it compresses the sciatic nerve causing radiating leg pain. Sitting is its main enemy.',
      },
      {
        name: 'Kręcenie biodrami stojąc',
        name_en: 'Standing Hip Circles',
        time: '1 min',
        requiresStanding: true,
        steps: [
          'Wstań z rękoma na biodrach, stopy na szerokość bioder.',
          'Wykonaj powolne duże kółko biodrami — jak hula-hoop.',
          'Ruch powinien być płynny i kontrolowany, nie szarpany.',
          'Wykonaj 10 kółek w jedną stronę, 10 w drugą.',
        ],
        stepsEn: [
          'Stand with hands on hips, feet hip-width apart.',
          'Make a slow, large circle with your hips — like a hula hoop.',
          'The movement should be smooth and controlled, not jerky.',
          'Do 10 circles in one direction, 10 in the other.',
        ],
        note: 'Mobilizuje staw biodrowy we wszystkich płaszczyznach ruchu — utrata tej mobilności przy siedzeniu jest przyczyną "chrupiących" bioder i bólu po wstaniu.',
        note_en: 'Mobilizes the hip joint in all planes of movement — loss of this mobility from sitting causes "clicking" hips and pain when standing up.',
      },
    ],
  },
  {
    ...
    areaEn: 'Traps',
    areaColor: '#8a9e6a',
    fasciaNote: 'Mięsień czworoboczny (trapez) i jego powięź rozciągają się od podstawy czaszki po środek pleców. Przy pracy przy komputerze górna część trapeza jest chronicznie napięta i uniesiona — "przyklejona" do uszu. To najczęstsze źródło bólu karku i barków u pracowników biurowych.',
    fasciaNote_en: 'The trapezius muscle and its fascia extend from the base of the skull to the middle of the back. During computer work, the upper trapezius is chronically tense and elevated — "glued" to the ears. This is the most common source of neck and shoulder pain in office workers.',
    exercises: [
      {
        name: 'Opuszczanie i rozciąganie trapeza',
        name_en: 'Trapezius Release',
        time: '1 min',
        steps: [
          'Usiądź prosto i świadomie "opuść" ramiona od uszu jak najniżej.',
          'Poczujesz ulgę — to jest naturalna pozycja ramion.',
          'Teraz przechyl głowę w prawo, lewą ręką delikatnie wzmocnij rozciąganie (chwytając głowę, nie ciągnąc).',
          'Utrzymaj 20 sekund. Zmień stronę.',
          'Na końcu wykonaj 3 głębokie oddechy utrzymując opuszczone ramiona.',
        ],
        stepsEn: [
          'Sit up straight and consciously "drop" your shoulders away from your ears as far as possible.',
          'You\'ll feel relief — this is the natural shoulder position.',
          'Now tilt your head to the right, left hand gently enhancing the stretch (holding the head, not pulling).',
          'Hold for 20 seconds. Switch sides.',
          'Finish with 3 deep breaths while keeping your shoulders dropped.',
        ],
        note: 'Górny trapez u pracowników biurowych jest trwale aktywny nawet w spoczynku — to "chroniczny skurcz". Świadome opuszczenie ramion przerywa ten wzorzec.',
        note_en: 'The upper trapezius in office workers is permanently active even at rest — a "chronic spasm". Consciously dropping your shoulders breaks this pattern.',
      },
      {
        name: 'Rollowanie barku na krześle',
        name_en: 'Shoulder Self-Massage',
        time: '1 min',
        steps: [
          'Prawą dłonią chwyć lewą mięsień kapturowy (między szyją a barkiem).',
          'Ściśnij delikatnie i "ugniataj" przez 20–30 sekund.',
          'Szukaj tkliwych punktów — zatrzymaj się na nich i trzymaj nacisk 10 sekund.',
          'Zmień stronę.',
        ],
        stepsEn: [
          'With your right hand, grip the left trapezius muscle (between neck and shoulder).',
          'Squeeze gently and "knead" for 20–30 seconds.',
          'Look for tender spots — pause on them and hold pressure for 10 seconds.',
          'Switch sides.',
        ],
        note: 'Automasaż trapeza uwalnia punkty spustowe (trigger points) odpowiedzialne za bóle głowy, bóle ramion i uczucie "kamienia" w karku.',
        note_en: 'Self-massage of the trapezius releases trigger points responsible for headaches, shoulder pain, and the feeling of a "rock" in the neck.',
      },
      {
        name: 'Wznosy barków z oddechu',
        name_en: 'Shoulder Shrugs with Breath',
        time: '1 min',
        steps: [
          'Usiądź prosto, ramiona rozluźnione.',
          'Na wdechu: unieś ramiona do uszu jak najwyżej i zatrzymaj.',
          'Na wydechu: gwałtownie opuść ramiona i rozluźnij całkowicie.',
          'Poczujesz wyraźne rozluźnienie po każdym opuszczeniu.',
          'Powtórz 8–10 razy, za każdym razem opuszczaj mocniej.',
        ],
        stepsEn: [
          'Sit up straight, shoulders relaxed.',
          'On the inhale: raise your shoulders to your ears as high as possible and hold.',
          'On the exhale: drop your shoulders sharply and completely relax.',
          'You\'ll feel a clear release with each drop.',
          'Repeat 8–10 times, dropping more forcefully each time.',
        ],
        note: 'Technika "wznieś i opuść" skuteczniej rozluźnia mięśnie niż samo rozciąganie — napięcie przed rozluźnieniem aktywuje odruch Golgiego.',
        note_en: '"Shrug and drop" technique is more effective than stretching alone — tensing before releasing activates the Golgi tendon reflex.',
      },
    ],
  },
  {
